        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="berandaAft">Beranda</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-3">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="kelasInggris" class="btn btn-primary">View details</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="kelasMandarin" class="btn btn-primary">View details</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="kelasIndonesia" class="btn btn-primary">View details</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="kelasJepang" class="btn btn-primary">View details</a>
                    </div>
                </div>
            </div>
        </div>
